...
InvoiceSubmission submission = InvoiceSubmission.builder()
    ...
    .supplier(InvoiceSubmission.PartyInput.builder().name("Acme GmbH").vatId("DE123456789").build())
    .buyer(InvoiceSubmission.PartyInput.builder().name("Buyer Co").leitwegId("991-12345-06").build())
